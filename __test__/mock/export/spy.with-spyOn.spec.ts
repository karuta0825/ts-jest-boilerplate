...
describe('spy export with spyOn', () => {
  let spy: jest.SpyInstance;
  beforeEach(() => {
    const original = require('../../../src/mock/export/double');
    // 第二引数がプロパティ名のdoubleになってることに注意
    spy = jest.spyOn(original, 'double');
  });
...
describe('spy and stub export', () => {
  ...
  beforeEach(() => {
    ...
    spy = jest.spyOn(original, 'double').mockReturnValue(1);
  });
